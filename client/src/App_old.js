...
class App extends Component {
  ...
  componentDidMount = async () => {
    ...
    // console.log('cleanup: delete ' + dirName);
    // await IPFSDatabase.deleteDirectory('/content/' + this.state.defaultAccount + '/inbox');
    // await IPFSDatabase.deleteDirectory('/content/' + this.state.defaultAccount);
    await IPFSDatabase.deleteDirectory('/content/');
    console.log('creating fresh directory /content');
    await IPFSDatabase.createDirectory('/content/');
    for (let account of accounts) {
        ...
        // await IPFSDatabase.createDirectory('/contact/' + account);this.state.
        // await IPFSDatabase.createDirectory('/contact/' + account + '/inbox');
        i += 1;
      }
      console.log('DONE - Generated contracts for test accounts');
